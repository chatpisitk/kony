function menuToggle() {
    ...
    else if (menuLeftPos === "0%") menuLeftPos = "85%";
...
function menuToggleStore() {
    ...
    frmStoreLocation.flxMain.animate(kony.ui.createAnimation({
        100: {
            left: menuLeftPos,
            "stepConfig": {}
        }
...
function menuToggleDetails() {
    ...
    frmProductDetail.flxMain.animate(kony.ui.createAnimation({
        100: {
            left: menuLeftPos,
            "stepConfig": {}
        }
...
function menuToggleProductList() {
    ...
    frmProduct.flxMain.animate(kony.ui.createAnimation({
        100: {
            left: menuLeftPos,
            "stepConfig": {}
        }
...
function menuToggleProductImage() {
    ...
    frmProductImage.flxMain.animate(kony.ui.createAnimation({
        100: {
            left: menuLeftPos,
            "stepConfig": {}
        }
