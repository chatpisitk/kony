function addWidgetsfrmStoreLocation() {
    ...
    var txtSearchCity = new kony.ui.TextBox2({
        ...
        "autoFilter": false,
        "placeholderSkin": "CopyslTextBox0f345f2bae21143"
    });
...
function frmStoreLocationGlobals() {
    frmStoreLocation = new kony.ui.Form2({
        ...
        "directChildrenIDs": ["btnBack", "btnCancel", "btnCart", "btnHamburger", "btnHome", "btnStore", "flxbar", "flxBtnOne", "flxBtnThree", "flxBtnTwo", "flxFindStore", "flxHeader", "flxMain", "flxMenu", "imgLogo", "imgMenuCart", "imgMenuHome", "imgMenuStore", "lblCart", "lblHome", "lblStore", "Line1", "Line2", "Line3", "lineHeader", "Maps", "txtSearchCity"],
